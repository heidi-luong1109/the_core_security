...
<head>
    ...
    <title>The Core SECURITY &rsaquo; Admin Panel</title>
...
?>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
	...
	<center><a href="dashboard.php" class="brand-link">
      <span class="brand-text font-weight-light"><i class="fab fa-get-pocket"></i> The Core SECURITY</span>
    </a></center>
...
<footer class="main-footer">
    ...
    <strong>&copy; <?php
    echo date("Y");
?> <a href="https://heidi.net.au/secure" target="_blank">The Core <b>SECURITY</b></a></strong>
